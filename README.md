...
1. This sample project consists of the app side, BK7258 device side, designed to demonstrate how to integrate the RTSA Lite SDK on the BK7258 chip platform and establish a connection with ConversationalAI to enable real-time conversation with AI Agent.
2. When using, please refer to the three respective open-source projects, install the APK, and then debug with the BK7258 device side.
3. The integration methods for each side are described in their respective README.md files in each directory:
